CREATE TABLE usuario (seq_usuario INT AUTO_INCREMENT NOT NULL, 
                      nom_usuario INT NOT NULL,
                      pwd_usuario INT VARCHAR(50) NOT NULL,
PRIMARY KEY(seq_usuario)) 
DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;

CREATE TABLE tipo_deficiencia (seq_tipo_deficiencia INT AUTO_INCREMENT NOT NULL, 
                              des_tipo_deficiencia INT NOT NULL,
PRIMARY KEY(seq_tipo_deficiencia)) 
DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;

CREATE TABLE tipo_acao (seq_tipo_acao INT AUTO_INCREMENT NOT NULL, 
                   des_tipo_acao VARCHAR(255) NOT NULL,
PRIMARY KEY(seq_tipo_acao)) 
DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;

CREATE TABLE pessoa (seq_pessoa INT AUTO_INCREMENT NOT NULL, 
...
CREATE TABLE contato (seq_contato INT AUTO_INCREMENT NOT NULL, 
...
CREATE TABLE voluntario (seq_voluntario INT NOT NULL, 
...
CREATE TABLE responsavel (seq_responsavel INT NOT NULL, 
...
CREATE TABLE menor (seq_menor INT NOT NULL, 
...
CREATE TABLE acao (seq_acao INT AUTO_INCREMENT NOT NULL, 
...
CREATE TABLE atendimento (seq_acao INT AUTO_INCREMENT NOT NULL, 
                   seq_voluntario INT NOT NULL,
                   seq_responsavel INT,
                   seq_menor INT,
